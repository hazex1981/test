...
@expert1.image = "taro.jpg"
@expert1.sex = "male"
@expert1.birthday = "01/03/1987"
...
@expert2.name = "jiro"
@expert2.email = "jiro@gmail.com"
@expert2.image = "jiro.jpg"
@expert2.sex = "male"
@expert2.birthday = "02/22/1987"
@expert2.bio = "私の名前は、jiroです"
@expert2.expert = true
@expert2.step = 1
@expert2.save

@fields[6].experts << @expert2
@fields[8].experts << @expert2
@fields[10].experts << @expert2
@jobs[5].experts << @expert2
